...
|---|---|---|
| **La interfaz visual, HTML, formularios y tarjetas** | `index.html` | [`public/index.html`](../public/index.html) |
| **Estilos CSS personalizados y tema visual** | `style.css` | [`public/style.css`](../public/style.css) |
| **Lógica de botones de Login/Registro y cambios de vista** | `ui-auth.js` | [`src/ui/ui-auth.js`](../src/ui/ui-auth.js) |
| **Pintar tarjetas de saldo, tabla de movimientos y filtros** | `dashboard.js` | [`src/ui/dashboard.js`](../src/ui/dashboard.js) |
| **Las alertas flotantes Toasts (errores, éxitos)** | `notificaciones.js` | [`src/ui/notificaciones.js`](../src/ui/notificaciones.js) |
| **Conexión con Firebase Auth (Login, Registro, Logout)** | `auth.js` | [`src/services/auth.js`](../src/services/auth.js) |
| **Guardar y leer de la base de datos Firestore** | `firestore.js` | [`src/services/firestore.js`](../src/services/firestore.js) |
| **Consumo de la API pública externa de la TRM del dólar** | `indicadores.js` | [`src/services/indicadores.js`](../src/services/indicadores.js) |
| **Reglas de negocio y estructura de una Transacción** | `Transaccion.js` | [`src/models/Transaccion.js`](../src/models/Transaccion.js) |
| **Formateo de moneda ($ COP) y fechas legibles** | `formateo.js` | [`src/utils/formateo.js`](../src/utils/formateo.js) |
| **El cerebro principal que arranca la aplicación** | `app.js` | [`src/app.js`](../src/app.js) |
...
- **¿Dónde está?**: Definido formalmente en [`src/models/Transaccion.js`](../src/models/Transaccion.js) y consumido en [`src/services/firestore.js`](../src/services/firestore.js).
